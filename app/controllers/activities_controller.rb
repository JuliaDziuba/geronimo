  ...
  def create
    ...
    if @activity.valid?
      if @activity.occurs_after_existing_final_activity
        flash[:error]= "This work is already " + @work.status + ". It is not available for new_activity.activitycategory. If this is not correct please correct the previous activities before creating this new one."  
        @success = false
