...
(function() {
  var add_activitywork, format_action_form, format_activity_form, format_note_form, hide_activity_form, toggle_print, toggle_sidebar;

  format_note_form = function() {
    var type;
    ...
    if (type === "Work") {
      return $('#note_form_works').show();
    } else if (type === "Venue") {
      return $('#note_form_venues').show();
    } else if (type === "Client") {
      return $('#note_form_clients').show();
    }
  };

  format_action_form = function() {
    var type;
    ...
    if (type === "Work") {
      return $('#action_form_works').show();
    } else if (type === "Venue") {
      return $('#action_form_venues').show();
    } else if (type === "Client") {
      return $('#action_form_clients').show();
    }
  };
  ...
  toggle_sidebar = function() {
    ...
    return $('#sidebar-content').toggleClass('show not-displayed');
  };

  hide_activity_form = function() {
    ...
    return $('#activity_form_works').hide();
  };

  format_activity_form = function() {
    var category;
    ...
    if (category === "Show" || category === "Consignment") {
      ...
      if (category === "Donation") {
        ...
        if (category === "Sale") {
          ...
          return $('#end_date').show();
        }
      }
    }
  };

  toggle_print = function() {
  ...
  add_activitywork = function(works_hash) {
    var new_id, new_line, old_id, re, work_array, work_id;
    ...
    if (work_id !== 'Select a work') {
      ...
      new_line.children('td').each((function(_this) {
        return function(index, td) {
          var e_id, e_name;
          ...
          if (typeof e_id !== "undefined" && e_id !== null) {
            ...
            return $(td).children('input').attr("value", "");
          }
        };
      })(this));
      ...
      return new_line.insertAfter('#activityworks tbody>tr:last');
    }
  };

  $(function() {
    return $('#activity_add_activitywork').click(function() {
      var a, s, works_array, works_hash, works_string, _i, _len;
      works_string = $('#activity_add_activitywork').attr('data-url').toString();
      works_array = works_string.split(',');
      works_hash = {};
      for (_i = 0, _len = works_array.length; _i < _len; _i++) {
        s = works_array[_i];
        a = s.split('-');
        works_hash[a[0]] = [a[1], a[2], a[3]];
      }
      return add_activitywork(works_hash);
    });
  });
  ...
  $(function() {
    return $(".popover-input").popover({
      trigger: "hover"
    }, console.log("Popover js has run"));
  });

  $(function() {
    return $(".display_toggle").click(function() {
      var element_id;
      element_id = $(this).attr("id").replace("_display", "");
      return $('#' + element_id).slideToggle();
    });
  });

  $(function() {
    return $(".document_print").click(function() {
      return toggle_print();
    });
  });
  ...
  $(function() {
    if (window.location.pathname.match(/activities\/new/)) {
      if (window.location.search.match(/\?category/)) {
        return format_activity_form();
      } else {
        return hide_activity_form();
      }
  ...
  $(function() {
    return $('#activity_category_id').change(function() {
      return format_activity_form();
    });
  });
  ...
  $(function() {
    if (window.location.pathname.match(/actions\/new/)) {
      return format_action_form();
    }
  });

  $(function() {
    return $('#action_item_actionable_type').change(function() {
      return format_action_form();
    });
  });
  ...
  $(function() {
    if (window.location.pathname.match(/notes\/new/)) {
      return format_note_form();
    }
  });

  $(function() {
    return $('#note_notable_type').change(function() {
      return format_note_form();
    });
  });
...
(function() {
  var hide_public_form, show_public_form;

  $(function() {
    if ($('#user_share_with_public').attr('checked') === "checked") {
      return show_public_form();
    }
  });

  $(function() {
    return $('#user_share_with_public').change(function() {
      if ($('#user_share_with_public').attr('checked') === "checked") {
        return show_public_form();
      } else {
        return hide_public_form();
      }
    });
  });

  $(function() {
    return $('#user_share_about').change(function() {
      if ($('#user_share_about').attr('checked') === "checked") {
        return $('#about_content').removeClass('not-displayed');
      } else {
        return $('#about_content').addClass('not-displayed');
      }
    });
  });

  $(function() {
    return $('#user_share_contact').change(function() {
      if ($('#user_share_contact').attr('checked') === "checked") {
        return $('#contact_content').removeClass('not-displayed');
      } else {
        return $('#contact_content').addClass('not-displayed');
      }
    });
  });

  $(function() {
    return $('#user_share_works').change(function() {
      if ($('#user_share_works').attr('checked') === "checked") {
        return $('#works_content').removeClass('not-displayed');
      } else {
        return $('#works_content').addClass('not-displayed');
      }
    });
  });

  $(function() {
    return $('#user_share_purchase').change(function() {
      if ($('#user_share_purchase').attr('checked') === "checked") {
        return $('#purchase_content').removeClass('not-displayed');
      } else {
        return $('#purchase_content').addClass('not-displayed');
      }
    });
  });

  show_public_form = function() {
  ...
  (function($) {
    jQuery.fn.extend({
      slimScroll: function(o) {
        ...
        ops = o;
        this.each(function() {
          var alwaysVisible, attachWheel, bar, barHeight, cheight, color, cwidth, divS, getBarHeight, hideBar, isDragg, isOverBar, isOverPanel, me, minBarHeight, opacity, posCss, position, queueHide, rail, scrollContent, showBar, size, wheelStep, wrapper, _onWheel;
          isOverPanel = void 0;
          isOverBar = void 0;
          isDragg = void 0;
          queueHide = void 0;
          ...
          bar.draggable({
            ...
            drag: function(e) {
              return scrollContent(0, $(this).position().top, false);
            }
          });
          rail.hover((function() {
            return showBar();
          ...
          scrollContent = function(x, y, isWheel) {
            var delta, maxTop, percentScroll;
            delta = y;
            if (isWheel) {
          ...
          attachWheel = function() {
            if (window.addEventListener) {
              ...
              return this.addEventListener("mousewheel", _onWheel, false);
            } else {
              return document.attachEvent("onmousewheel", _onWheel);
            }
          };
          attachWheel();
          ...
          showBar = function() {
            ...
            return bar.fadeIn("fast");
          };
          return hideBar = function() {
            if (!alwaysVisible) {
              return queueHide = setTimeout(function() {
                if (!isOverBar && !isDragg) {
                  return bar.fadeOut("slow");
                }
              }, 1000);
            }
          };
